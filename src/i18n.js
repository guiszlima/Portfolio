  ...
  resources: {
    en: {
      translation: {
        ...
        desc_json_generator_for_printers:'This Python project is a CLI designed for registering and managing printers, enabling their automated installation on Windows.',
        desc_auto_print_installer:'This Python project is a tool for automatically installing printers on a system. It simplifies the process of configuring printers, saving time and effort.',
        desc_projeto_gota_de_mel:'POS integrated with WooCommerce and developed with Laravel ',
        desc_auth_api:'This authentication API is built using Node.js, Express, and JWT (JSON Web Token). It allows registering new users, logging in, and verifying the authenticity of provided tokens.',
...
If you're looking for someone to bring your project to life or improve what's already there, let's chat! 🙂`,
    ...
    pt: {
      translation: {
        ...
        desc_json_generator_for_printers:'Esse projeto em Python é um CLI feita para o registro e administração de impressoras para a instalação automatizada delas no windows',
        desc_auto_print_installer:'Este projeto em Python é uma ferramenta para a instalação automática de impressoras em um sistema. Ele simplifica o processo de configuração de impressoras, economizando tempo e esforço.',
        desc_projeto_gota_de_mel:'PDV (Ponto de Venda) integrado ao WooCommerce, desenvolvido com Laravel, permitindo a sincronização em tempo real de estoque, pedidos e produtos. Oferece uma solução prática e eficiente para gerenciar vendas de forma integrada entre lojas físicas e online, com uma interface simples e funcional.',
        desc_auth_api:'API de Autenticação com Node.js Esta API de autenticação é construída usando Node.js, Express, e JWT (JSON Web Token). Ela permite registrar novos usuários, realizar login e verificar a autenticidade dos tokens fornecidos.',
        about_me:`
